...
export const DATA = {
  ...
  contact: {
    email: "tanmayjain4477@gmail.com",
    tel: "+91 7065339197",
    social: {
      GitHub: {
        name: "GitHub",
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/tanmay-jain5/",
        icon: Icons.linkedin,
      ...
      X: {
        name: "X",
        url: "https://x.com/tanmayjain5114",
        icon: Icons.x,
  ...
  education: [
    ...
    },
    {
      ...
      degree: "Bachelor's of Management Studies (BMS)",
      logoUrl: "/University_of_Delhi.png",
      start: "2021",
      end: "2024",
    },
  ],
  projects: [
    {
      ...
      active: true,
      description:
        "Created an opinion trading platform where users can trade upon opinions, buy and sell opposite opinions and win money.",
      technologies: [
        "Express",
        "Typescript",
        "Redis",
    ...
    },
    {
      ...
      active: true,
      description:
        "An app where users can join rooms or spaces and interact with each other and get info about other's position in the room",
      technologies: [
        "Python",
        "FastAPI",
        "SQLModel",
    ...
    },
    {
      ...
      active: true,
      description:
        "Created a platform where users can practice for their interview with the help of AI",
      technologies: [
        "Python",
        "FastAPI",
        "CI/CD",
